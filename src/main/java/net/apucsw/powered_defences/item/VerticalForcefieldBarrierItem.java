...
import net.apucsw.powered_defences.procedures.FFBV_RightClickedOnBlockProcedure;
import net.apucsw.powered_defences.init.PoweredDefencesModTabs;

import java.util.List;

public class VerticalForcefieldBarrierItem extends Item {
	public VerticalForcefieldBarrierItem() {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		FFBV_RightClickedOnBlockProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(),
